...
export function NavMenu() {
  return (
    <div className="flex justify-center text-whit">
      <NavigationMenu className="">
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger className="transition-none bg-inherit text-white focus:bg-inherit focus:text-white">
              Projects
            </NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid gap-1 p-2 md:w-80 lg:min-w-96 lg:grid-cols-[2fr] text-custom-red">
                <ListItem href="/docs/installation" title="My store">
                  ...
                  It was created as an online store for selling clothes, but it
                  is very easily adaptable for other products as well.
                </ListItem>
                ...
                >
                  ...
                  homemade sweets. It includes a database and administrator
                  login functionality.
                </ListItem>
                <ListItem
                  href="/docs/primitives/typography"
                ...
                >
                  ...
                  collection and comparison of followers and users being
                  followed.
                </ListItem>
              </ul>
            </NavigationMenuContent>
          ...
          <NavigationMenuItem className="bg-inherit hover:bg-inherit ">
            <NavigationMenuTrigger className="focus:bg-inherit focus:text-white bg-inherit text-white hover:bg-inherit hover:text-custom-red">
              Contact
            </NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid w-40 gap-3 p-4 md:w-30 md:grid-cols-1 lg:w-80">
                <ListItem
                  title="Contact"
                  href="https://linkedin.com/in/ivan-ravi%C4%87-b3aa36143"
                >
