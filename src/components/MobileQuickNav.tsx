...
export default function MobileQuickNav() {
  ...
  const itemClass =
    'flex h-12 w-12 items-center justify-center rounded-full text-foreground/80 transition-colors hover:text-custom-red focus-visible:text-custom-red focus-visible:outline-none';
